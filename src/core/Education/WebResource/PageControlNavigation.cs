...
{
    [ID("Navigation")]
    [Title("page.control.navigation.name")]
    [Segment("navigation", "page.control.navigation.name")]
    [Path("/Control")]
    [Module("edu")]
    [Context("control")]
    public sealed class PageControlNavigation : PageControlBase
    {
        ...
        public override void Initialization()
        {
            ...
            (
                ...
                (
                    CreateLink(1, "Eins", string.IsNullOrWhiteSpace(GetParamValue("link")) || GetParamValue("link") == "1" ? TypeActive.Active : TypeActive.None),
                    CreateLink(2, "Zwei", GetParamValue("link") == "2" ? TypeActive.Active : TypeActive.None),
                    CreateLink(3, "Drei", GetParamValue("link") == "3" ? TypeActive.Active : TypeActive.None)
                )
                {
            ...
            (
                ...
                new ControlNavigation
                (
                    CreateLink(1, "Eins", string.IsNullOrWhiteSpace(GetParamValue("GetParamValue")) || GetParamValue("link") == "1" ? TypeActive.Active : TypeActive.None),
                    CreateLink(2, "Zwei", GetParamValue("link") == "2" ? TypeActive.Active : TypeActive.None),
                    CreateLink(3, "Drei", GetParamValue("link") == "3" ? TypeActive.Active : TypeActive.None)
                )
                {
