...
namespace Education.WebPage
{
    ...
    [Title("education:page.control.formular.item.groupcolumnhorizontal.name")]
    [Segment("formulargroupcolumnhorizontal", "education:page.control.formular.item.groupcolumnhorizontal.name")]
    [Path("/Control")]
    [Module("edu")]
    [Context("control")]
